...
def test_archive():
    ...
    url = "/add/"
    data = {"new_todo": "Task 1", "priority": "1", "dow": "Friday"}
    response = client.post(url, data=data)
    data = {"new_todo": "Task 2", "priority": "2", "dow": "Wednesday"}
    response = client.post(url, data=data)
    data = {"new_todo": "Task 3", "priority": "3", "dow": "Monday"}
    response = client.post(url, data=data)
    data = {"new_todo": "Task 4", "priority": "4", "dow": "Sunday"}
    response = client.post(url, data=data)
